...
class App extends Component {
    ...
    componentDidMount() {
        ajax({url: 'https://api.github.com/users/kovcic?client_id=8a6b65d1f52e440fba8e&client_secret=50c87ef75640625225e26de657502e602be60e48', type: 'json'}, (resp) => {
            if (resp.status === 200) {
                this.setState({
                    data: resp.data,
                });
                ...
                this.setState({
                    err: resp.error + ' ' + JSON.stringify(resp.data) + ' ' + JSON.stringify(resp.headers),
                });
            }
        });
